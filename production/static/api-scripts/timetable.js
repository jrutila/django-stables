...
.done(function(data) {
    ...
    for (var d = start; d <= end; d.setDate(d.getDate() + 1))
    {
        var md = moment(d);
        var $day = $('<ul></ul>');
        $output.append($('<li>'+md.format('dd DoM')+'</li>').append($day));
