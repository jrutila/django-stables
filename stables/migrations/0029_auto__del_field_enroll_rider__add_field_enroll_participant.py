...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Enroll.rider'
        db.delete_column('stables_enroll', 'rider_id')

        # Adding field 'Enroll.participant'
        db.add_column('stables_enroll', 'participant', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['stables.UserProfile']), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Enroll.rider'
        db.add_column('stables_enroll', 'rider', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['stables.RiderInfo']), keep_default=False)

        # Deleting field 'Enroll.participant'
        db.delete_column('stables_enroll', 'participant_id')
    ...
    models = {
        ...
        'stables.enroll': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_state_change_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 15, 22, 3, 22, 152370)'}),
        ...
        'stables.ticket': {
            ...
            'expires': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 5, 22, 3, 22, 132029)', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
