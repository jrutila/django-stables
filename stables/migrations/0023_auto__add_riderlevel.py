...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('stables_riderlevel', (
        ...
        db.create_table('stables_riderlevel_includes', (
        ...
        db.create_unique('stables_riderlevel_includes', ['from_riderlevel_id', 'to_riderlevel_id'])


    def backwards(self, orm):
        
        # Deleting model 'RiderLevel'
        db.delete_table('stables_riderlevel')

        # Removing M2M table for field includes on 'RiderLevel'
        db.delete_table('stables_riderlevel_includes')
    ...
    models = {
        ...
        'stables.riderlevel': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'includes': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'includes_rel_+'", 'to': "orm['stables.RiderLevel']"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '30'})
        },
        'stables.ticket': {
            'Meta': {'object_name': 'Ticket'},
            'expires': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 4, 21, 30, 12, 647404)', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
