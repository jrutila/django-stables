...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.inactive'
        db.add_column(u'stables_userprofile', 'inactive',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.inactive'
        db.delete_column(u'stables_userprofile', 'inactive')
