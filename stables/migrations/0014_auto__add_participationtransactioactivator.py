...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ParticipationTransactioActivator'
        db.create_table('stables_participationtransactioactivator', (
        ...
        db.send_create_signal('stables', ['ParticipationTransactioActivator'])


    def backwards(self, orm):
        
        # Deleting model 'ParticipationTransactioActivator'
        db.delete_table('stables_participationtransactioactivator')
