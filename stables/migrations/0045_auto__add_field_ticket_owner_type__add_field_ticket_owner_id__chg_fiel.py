...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ticket.owner_type'
        db.add_column('stables_ticket', 'owner_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True),
                      keep_default=False)

        # Adding field 'Ticket.owner_id'
        db.add_column('stables_ticket', 'owner_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Ticket.owner_type'
        db.delete_column('stables_ticket', 'owner_type_id')

        # Deleting field 'Ticket.owner_id'
        db.delete_column('stables_ticket', 'owner_id')

        db.alter_column('stables_ticket', 'rider_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['stables.RiderInfo'], null=False))
    ...
    models = {
        ...
        'stables.ticket': {
            ...
            'rider': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['stables.RiderInfo']", 'null': 'True'}),
