...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('stables_instructorparticipation', (
        ...
        db.create_table('stables_instructorinfo', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('stables', ['InstructorInfo'])

        # Adding field 'UserProfile.instructor'
        db.add_column('stables_userprofile', 'instructor',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['stables.InstructorInfo'], unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'InstructorParticipation'
        db.delete_table('stables_instructorparticipation')

        # Deleting model 'InstructorInfo'
        db.delete_table('stables_instructorinfo')

        # Deleting field 'UserProfile.instructor'
        db.delete_column('stables_userprofile', 'instructor_id')
    ...
    models = {
        ...
        'stables.enroll': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_state_change_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 22, 0, 0)'}),
        ...
        'stables.ticket': {
            ...
            'expires': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 13, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
