...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Course.api_hide'
        db.add_column(u'stables_course', 'api_hide',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Course.api_hide'
        db.delete_column(u'stables_course', 'api_hide')
    ...
    models = {
        ...
        'stables.course': {
            ...
            'api_hide': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        'stables.enroll': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_state_change_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 25, 0, 0)'}),
