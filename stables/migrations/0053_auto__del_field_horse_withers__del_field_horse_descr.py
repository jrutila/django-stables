...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'stables_horse', 'withers')

        # Deleting field 'Horse.description'
        db.delete_column(u'stables_horse', 'description')

        # Deleting field 'Horse.birthday'
        db.delete_column(u'stables_horse', 'birthday')

        # Deleting field 'Horse.mugshot'
        db.delete_column(u'stables_horse', 'mugshot_id')

        # Deleting field 'Horse.nickname'
        db.delete_column(u'stables_horse', 'nickname')

        # Deleting field 'Horse.gender'
        db.delete_column(u'stables_horse', 'gender')

        # Deleting field 'Horse.breed'
        db.delete_column(u'stables_horse', 'breed')

        # Deleting field 'Horse.public'
        db.delete_column(u'stables_horse', 'public')


    def backwards(self, orm):
        # Adding field 'Horse.withers'
        db.add_column(u'stables_horse', 'withers',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Horse.description'
        db.add_column(u'stables_horse', 'description',
                      self.gf('django.db.models.fields.TextField')(max_length=2500, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Horse.birthday'
        db.add_column(u'stables_horse', 'birthday',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Horse.mugshot'
        db.add_column(u'stables_horse', 'mugshot',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filer.Image'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Horse.nickname'
        db.add_column(u'stables_horse', 'nickname',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Horse.gender'
        db.add_column(u'stables_horse', 'gender',
                      self.gf('django.db.models.fields.CharField')(max_length=1, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Horse.breed'
        db.add_column(u'stables_horse', 'breed',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Horse.public'
        db.add_column(u'stables_horse', 'public',
    ...
    models = {
        ...
        'stables.enroll': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_state_change_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 5, 0, 0)'}),
        ...
        'stables.ticket': {
            ...
            'expires': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 5, 0, 0)', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
