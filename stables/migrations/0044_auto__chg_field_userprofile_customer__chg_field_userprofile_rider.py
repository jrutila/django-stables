...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('stables_userprofile', 'customer_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['stables.CustomerInfo'], unique=True, null=True, on_delete=models.SET_NULL))

        # Changing field 'UserProfile.rider'
        db.alter_column('stables_userprofile', 'rider_id', self.gf('django.db.models.fields.related.OneToOneField')(null=True, on_delete=models.SET_NULL, to=orm['stables.RiderInfo'], unique=True))
