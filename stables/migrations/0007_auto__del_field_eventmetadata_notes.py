...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'EventMetaData.notes'
        db.delete_column(u'stables_eventmetadata', 'notes')


    def backwards(self, orm):
        # Adding field 'EventMetaData.notes'
        db.add_column(u'stables_eventmetadata', 'notes',
