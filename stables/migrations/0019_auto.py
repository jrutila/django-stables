...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('stables_course_ticket_type', (
        ...
        db.create_unique('stables_course_ticket_type', ['course_id', 'tickettype_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field ticket_type on 'Course'
        db.delete_table('stables_course_ticket_type')
    ...
    models = {
        ...
        'stables.ticket': {
            ...
            'expires': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 28, 21, 49, 39, 677469)', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
