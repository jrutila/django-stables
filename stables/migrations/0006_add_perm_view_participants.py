...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        ct, created = orm['contenttypes.ContentType'].objects.get_or_create(model='course', app_label='stables')
        perm, created = orm['auth.permission'].objects.get_or_create(content_type=ct, codename='course_view_participants')
        if created:
            perm.name=u"Can see detailed participations"
            perm.save()

    def backwards(self, orm):
        "Write your backwards methods here."
        perm = orm['auth.permission'].objects.filter(content_type=ct, codename='course_view_participants')
        perm.delete()
    ...
    models = {
        ...
        'stables.enroll': {
            ...
            'attended_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 28, 20, 58, 16, 384612)'}),
