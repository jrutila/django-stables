...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Participation.horse'
        db.add_column('stables_participation', 'horse', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['stables.Horse'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Participation.horse'
        db.delete_column('stables_participation', 'horse_id')
    ...
    models = {
        ...
        'stables.enroll': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_state_change_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 12, 8, 7, 43, 55229)'}),
        ...
        'stables.ticket': {
            ...
            'expires': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 3, 8, 7, 42, 993312)', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
