...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CourseEventTransactionActivator'
        db.create_table('stables_courseeventtransactionactivator', (
        ...
        db.send_create_signal('stables', ['CourseEventTransactionActivator'])

        # Adding model 'ActivatedCourseTransaction'
        db.create_table('stables_activatedcoursetransaction', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('enroll', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['stables.Enroll'])),
            ('start', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal('stables', ['ActivatedCourseTransaction'])

        # Changing field 'Course.end'
        db.alter_column('stables_course', 'end', self.gf('django.db.models.fields.DateField')(null=True))


    def backwards(self, orm):
        
        # Deleting model 'CourseEventTransactionActivator'
        db.delete_table('stables_courseeventtransactionactivator')

        # Deleting model 'ActivatedCourseTransaction'
        db.delete_table('stables_activatedcoursetransaction')

        # User chose to not deal with backwards NULL issues for 'Course.end'
        raise RuntimeError("Cannot reverse this migration. 'Course.end' and its values cannot be restored.")
    ...
    models = {
        ...
        'stables.activatedcoursetransaction': {
            'Meta': {'object_name': 'ActivatedCourseTransaction'},
        ...
        'stables.courseeventtransactionactivator': {
            'Meta': {'object_name': 'CourseEventTransactionActivator'},
        ...
        'stables.enroll': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_state_change_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 9, 11, 34, 27, 577969)'}),
        ...
        'stables.ticket': {
            ...
            'expires': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 30, 11, 34, 27, 559870)', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
