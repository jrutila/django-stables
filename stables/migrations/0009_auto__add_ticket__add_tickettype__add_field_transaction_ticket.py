...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Ticket'
        db.create_table('stables_ticket', (
        ...
        db.create_table('stables_tickettype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table('stables_ticket')

        # Deleting model 'TicketType'
        db.delete_table('stables_tickettype')
    ...
    models = {
        ...
        'stables.transaction': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ticket': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['stables.Ticket']", 'null': 'True', 'blank': 'True'})
        },
        'stables.userprofile': {
