...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'stables_course', 'creator_id')

        # Deleting field 'Course.created_on'
        db.delete_column(u'stables_course', 'created_on')

        # Deleting field 'Course.end'
        db.delete_column(u'stables_course', 'end')

        # Deleting field 'Course.start'
        db.delete_column(u'stables_course', 'start')

        # Deleting field 'Course.course_fee'
        db.delete_column(u'stables_course', 'course_fee')

        # Deleting field 'EventMetaData.default_participation_fee'
        db.delete_column(u'stables_eventmetadata', 'default_participation_fee')

        # Deleting field 'EventMetaData.max_participants'
        db.delete_column(u'stables_eventmetadata', 'max_participants')
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'stables_course', 'creator',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True),
                      keep_default=False)

        # Adding field 'Course.created_on'
        db.add_column(u'stables_course', 'created_on',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)

        # Adding field 'Course.end'
        db.add_column(u'stables_course', 'end',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Course.start'
        raise RuntimeError("Cannot reverse this migration. 'Course.start' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Course.start'
        db.add_column(u'stables_course', 'start',
                      self.gf('django.db.models.fields.DateField')(),
                      keep_default=False)

        # Adding field 'Course.course_fee'
        db.add_column(u'stables_course', 'course_fee',
                      self.gf('stables.models.financial.CurrencyField')(default=0, max_digits=10, decimal_places=2),
                      keep_default=False)

        # Adding field 'EventMetaData.default_participation_fee'
        db.add_column(u'stables_eventmetadata', 'default_participation_fee',
                      self.gf('stables.models.financial.CurrencyField')(null=True, max_digits=10, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'EventMetaData.max_participants'
        db.add_column(u'stables_eventmetadata', 'max_participants',
    ...
    models = {
        ...
        'stables.enroll': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_state_change_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 7, 0, 0)'}),
        ...
        'stables.horse': {
            'Meta': {'ordering': "['name']", 'object_name': 'Horse'},
        ...
        'stables.transaction': {
            ...
            'customer': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['stables.CustomerInfo']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'method': ('django.db.models.fields.CharField', [], {'max_length': '35', 'null': 'True', 'blank': 'True'}),
