...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing M2M table for field riders on 'CustomerInfo'
        db.delete_table('stables_customerinfo_riders')

        # Adding field 'RiderInfo.customer'
        db.add_column('stables_riderinfo', 'customer', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['stables.CustomerInfo']), keep_default=False)


    def backwards(self, orm):
        
        # Adding M2M table for field riders on 'CustomerInfo'
        db.create_table('stables_customerinfo_riders', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('customerinfo', models.ForeignKey(orm['stables.customerinfo'], null=False)),
            ('riderinfo', models.ForeignKey(orm['stables.riderinfo'], null=False))
        ))
        db.create_unique('stables_customerinfo_riders', ['customerinfo_id', 'riderinfo_id'])

        # Deleting field 'RiderInfo.customer'
        db.delete_column('stables_riderinfo', 'customer_id')
    ...
    models = {
        ...
        'stables.participationtransactioactivator': {
            'Meta': {'object_name': 'ParticipationTransactioActivator'},
