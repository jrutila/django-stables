...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'RiderInfo.level'
        db.delete_column('stables_riderinfo', 'level')

        # Adding M2M table for field levels on 'RiderInfo'
        db.create_table('stables_riderinfo_levels', (
        ...
        db.create_unique('stables_riderinfo_levels', ['riderinfo_id', 'riderlevel_id'])


    def backwards(self, orm):
        
        # Adding field 'RiderInfo.level'
        db.add_column('stables_riderinfo', 'level', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Removing M2M table for field levels on 'RiderInfo'
        db.delete_table('stables_riderinfo_levels')
    ...
    models = {
        ...
        'stables.ticket': {
            ...
            'expires': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 4, 21, 41, 52, 44352)', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
