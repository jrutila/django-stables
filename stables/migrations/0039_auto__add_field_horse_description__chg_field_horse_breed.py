...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('stables_horse', 'description',
                      self.gf('django.db.models.fields.TextField')(max_length=2500, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Horse.breed'
        db.alter_column('stables_horse', 'breed', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))

    def backwards(self, orm):
        # Deleting field 'Horse.description'
        db.delete_column('stables_horse', 'description')


        # Changing field 'Horse.breed'
        db.alter_column('stables_horse', 'breed', self.gf('django.db.models.fields.CharField')(max_length=500L, null=True))
    ...
    models = {
        ...
        'stables.enroll': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_state_change_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 23, 0, 0)'}),
        ...
        'stables.ticket': {
            ...
            'expires': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 14, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
