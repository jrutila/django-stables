...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Ticket.owner_id'
        db.alter_column('stables_ticket', 'owner_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=False))
        # Changing field 'Ticket.owner_type_id'
        db.alter_column('stables_ticket', 'owner_type_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=False))

    def backwards(self, orm):
        # Adding field 'Ticket.rider'
        db.add_column('stables_ticket', 'rider',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['stables.RiderInfo'], null=True),
                      keep_default=False)
    ...
    models = {
        ...
        'stables.enroll': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_state_change_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 17, 0, 0)'}),
        ...
        'stables.ticket': {
            ...
            'expires': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 8, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
