...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        db.execute('update stables_participation p SET start=o.start, "end"=o.end from schedule_occurrence o where o.event_id = p.event_id AND p.start = o.original_start')

    def backwards(self, orm):
        db.execute('update stables_participation p SET start=o.original_start, "end"=o.original_end from schedule_occurrence o where o.event_id = p.event_id AND p.start = o.start;')
    ...
    models = {
        ...
        'stables.enroll': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_state_change_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 29, 0, 0)'}),
        ...
        'stables.ticket': {
            ...
            'expires': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 20, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
    ...
    complete_apps = ['schedule', 'stables']
    symmetrical = True
