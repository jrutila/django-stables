...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ParticipationTransactioActivator.fee'
        db.add_column('stables_participationtransactioactivator', 'fee', self.gf('stables.models.financial.CurrencyField')(default=0, max_digits=10, decimal_places=2), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ParticipationTransactioActivator.fee'
        db.delete_column('stables_participationtransactioactivator', 'fee')
    ...
    models = {
        ...
        'stables.customerinfo': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'riders': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['stables.RiderInfo']", 'symmetrical': 'False'})
        },
