...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'stables_userprofile', 'extra',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'UserProfile.phone_number'
        db.alter_column(u'stables_userprofile', 'phone_number', self.gf('phonenumber_field.modelfields.PhoneNumberField')(max_length=128, null=True))

    def backwards(self, orm):
        # Deleting field 'UserProfile.extra'
        db.delete_column(u'stables_userprofile', 'extra')


        # Changing field 'UserProfile.phone_number'
        db.alter_column(u'stables_userprofile', 'phone_number', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))
    ...
    models = {
        ...
        'stables.enroll': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_state_change_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 6, 0, 0)'}),
        ...
        'stables.ticket': {
            ...
            'expires': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 6, 0, 0)', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
