...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Participation', fields ['start', 'end', 'participant', 'event']
        db.create_unique('stables_participation', ['start', 'end', 'participant_id', 'event_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Participation', fields ['start', 'end', 'participant', 'event']
        db.delete_unique('stables_participation', ['start', 'end', 'participant_id', 'event_id'])
