...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CourseEventTransactionActivator.fee'
        db.add_column('stables_courseeventtransactionactivator', 'fee', self.gf('stables.models.financial.CurrencyField')(default=Decimal(0), max_digits=10, decimal_places=2), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CourseEventTransactionActivator.fee'
        db.delete_column('stables_courseeventtransactionactivator', 'fee')
    ...
    models = {
        ...
        'stables.enroll': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_state_change_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 9, 11, 40, 33, 218576)'}),
        ...
        'stables.ticket': {
            ...
            'expires': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 30, 11, 40, 33, 199901)', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
