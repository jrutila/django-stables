...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Transaction.method'
        db.add_column(u'stables_transaction', 'method',
                      self.gf('django.db.models.fields.CharField')(max_length=35, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Transaction.method'
        db.delete_column(u'stables_transaction', 'method')
    ...
    models = {
        ...
        'stables.enroll': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_state_change_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 10, 0, 0)'}),
