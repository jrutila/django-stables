...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'CoursePlugin.course'
        db.delete_column('cmsplugin_courseplugin', 'course_id')

        # Adding M2M table for field courses on 'CoursePlugin'
        db.create_table('stables_courseplugin_courses', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('courseplugin', models.ForeignKey(orm['stables.courseplugin'], null=False)),
            ('course', models.ForeignKey(orm['stables.course'], null=False))
        ))
        db.create_unique('stables_courseplugin_courses', ['courseplugin_id', 'course_id'])


    def backwards(self, orm):
        
        # Adding field 'CoursePlugin.course'
        db.add_column('cmsplugin_courseplugin', 'course', self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='plugins', to=orm['stables.Course']), keep_default=False)

        # Removing M2M table for field courses on 'CoursePlugin'
        db.delete_table('stables_courseplugin_courses')
    ...
    models = {
        ...
        'stables.ticket': {
            ...
            'expires': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 3, 21, 35, 46, 100886)', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
