...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Transaction.content_type'
        db.add_column('stables_transaction', 'content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True, blank=True), keep_default=False)

        # Adding field 'Transaction.object_id'
        db.add_column('stables_transaction', 'object_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Transaction.content_type'
        db.delete_column('stables_transaction', 'content_type_id')

        # Deleting field 'Transaction.object_id'
        db.delete_column('stables_transaction', 'object_id')
