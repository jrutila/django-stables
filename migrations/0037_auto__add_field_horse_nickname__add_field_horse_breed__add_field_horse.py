...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Horse.nickname'
        db.add_column('stables_horse', 'nickname', self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True), keep_default=False)

        # Adding field 'Horse.breed'
        db.add_column('stables_horse', 'breed', self.gf('django.db.models.fields.CharField')(max_length=500L, null=True, blank=True), keep_default=False)

        # Adding field 'Horse.withers'
        db.add_column('stables_horse', 'withers', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Changing field 'Horse.birthday'
        db.alter_column('stables_horse', 'birthday', self.gf('django.db.models.fields.DateField')(null=True))


    def backwards(self, orm):
        
        # Deleting field 'Horse.nickname'
        db.delete_column('stables_horse', 'nickname')

        # Deleting field 'Horse.breed'
        db.delete_column('stables_horse', 'breed')

        # Deleting field 'Horse.withers'
        db.delete_column('stables_horse', 'withers')

        # Changing field 'Horse.birthday'
        db.alter_column('stables_horse', 'birthday', self.gf('django.db.models.fields.DateField')(default=datetime.date(2012, 4, 4)))
    ...
    models = {
        ...
        'stables.enroll': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_state_change_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 4, 7, 3, 52, 507868)'}),
        ...
        'stables.horse': {
            ...
            'breed': ('django.db.models.fields.CharField', [], {'max_length': '500L', 'null': 'True', 'blank': 'True'}),
        ...
        'stables.ticket': {
            ...
            'expires': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 26, 7, 3, 52, 489086)', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'taggit.tag': {
            ...
            'unique_hash': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '40', 'db_index': 'True'})
        },
        'taggit.taggeditem': {
