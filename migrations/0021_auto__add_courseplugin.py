...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CoursePlugin'
        db.create_table('cmsplugin_courseplugin', (
            ('cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('course', self.gf('django.db.models.fields.related.ForeignKey')(related_name='plugins', to=orm['stables.Course'])),
        ))
        db.send_create_signal('stables', ['CoursePlugin'])


    def backwards(self, orm):
        
        # Deleting model 'CoursePlugin'
        db.delete_table('cmsplugin_courseplugin')
    ...
    models = {
        ...
        'stables.courseplugin': {
            ...
            'course': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'plugins'", 'to': "orm['stables.Course']"})
        },
        ...
        'stables.ticket': {
            ...
            'expires': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 3, 18, 58, 35, 179081)', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
