...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Transaction.ticket'
        db.delete_column('stables_transaction', 'ticket_id')

        # Adding field 'Ticket.rider'
        db.add_column('stables_ticket', 'rider', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['stables.RiderInfo']), keep_default=False)

        # Adding field 'Ticket.transaction'
        db.add_column('stables_ticket', 'transaction', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['stables.Transaction'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Transaction.ticket'
        db.add_column('stables_transaction', 'ticket', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['stables.Ticket'], null=True, blank=True), keep_default=False)

        # Deleting field 'Ticket.rider'
        db.delete_column('stables_ticket', 'rider_id')

        # Deleting field 'Ticket.transaction'
        db.delete_column('stables_ticket', 'transaction_id')
