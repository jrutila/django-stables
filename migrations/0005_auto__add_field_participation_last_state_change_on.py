...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Participation.last_state_change_on'
        db.add_column('stables_participation', 'last_state_change_on', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Participation.last_state_change_on'
        db.delete_column('stables_participation', 'last_state_change_on')
    ...
    models = {
        ...
        'stables.enroll': {
            ...
            'attended_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 23, 14, 36, 58, 514432)'}),
