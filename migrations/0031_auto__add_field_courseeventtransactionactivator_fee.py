...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('stables_courseeventtransactionactivator', 'fee', self.gf('stables.models.financial.CurrencyField')(default=0.0, max_digits=10, decimal_places=2), keep_default=False)
