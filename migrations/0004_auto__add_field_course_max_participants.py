...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Course.max_participants'
        db.add_column('stables_course', 'max_participants', self.gf('django.db.models.fields.IntegerField')(default=7), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Course.max_participants'
        db.delete_column('stables_course', 'max_participants')
    ...
    models = {
        ...
        'stables.enroll': {
            ...
            'attended_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 22, 15, 16, 13, 516339)'}),
